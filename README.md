...
* **Invalid State (Exit 15):** This happens if your PC crashes or Steam is force-closed via Task Manager while the watcher was running. The `greenluma.lock` file wasn't deleted.
